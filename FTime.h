...
namespace Forte
{
    ...
    public:
        ...
        time_t f_to_time_t(const char *filename,
                           int line,
                           const char *arg,
        ...
        ///
        std::string ToStr(const boost::posix_time::ptime &pt,
                          const std::string &tz,
                          const char *format = NULL);

        std::string ToStr(const time_t t,
                          const std::string &tz,
                          const char *format = NULL);
        ...
        boost::posix_time::ptime FromTimeT(time_t t, const char *tz);

        // get the day
        time_t Day(time_t t, const char *tz);
        time_t Day(const boost::posix_time::ptime pt, const char *tz);
    protected:
        Forte::Mutex mLock;
        boost::local_time::tz_database mTimezoneDb;
    };
};
